...
\hypertarget{bi-variate-relationships}{%
\subsubsection{Bi-variate relationships}\label{bi-variate-relationships}}
...
Because relationships can occur by chance, we engage in hyp

Hypotheis testing is central to statistics. We form our own hypothesis about a potential relationship between variables and then compare this against what is known as the null hypothesis. The null hypothesis represents the notion that nothing special has occured and that the relationship we are observing could only have occured by chance, i.e.~getting heads when flipping a coin.
